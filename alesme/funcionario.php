...
if(isset($_POST['submit']))
{
    ...
    $result = mysqli_query($conexao, "INSERT INTO funcionario(nome,email,senha,telefone,sexo,data_nascimento,cidade,estado,endereco) 
    ...
    <form action="funcionario.php" method="POST">
            <fieldset>
                ...
                <div class="inputBox">
                 ...
                 <br>
                <p>Sexo:</p>
                <input type="radio" id="feminino" name="sexo" value="atendente" required>
                <label for="feminino">ATENDENTE</label>
                <br>
                <input type="radio" id="masculino" name="sexo" value="gerente" required>
                <label for="masculino">GERENTE</label>
                <br>
                <input type="radio" id="outro" name="sexo" value="mecanico" required>
                <label for="outro">MECÂNICO</label>
                <br><br>
